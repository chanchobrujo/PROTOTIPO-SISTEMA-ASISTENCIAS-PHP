									...
									<table>
										...
										<tr>
											<td>
												<center>
													<div class="div_tab1">
														<input type="hidden" id="d" name="dni_t">
														<table class="t1">
															<tr>
																<th colspan="4"><div class="d1">LISTA</div><hr></th>
															</tr>
															...
															<?php
															$lista = mYsqli_query($con,"select * from vista_alumno1") or die("error: ".mysqli_error($con));
															while ($mostrar = mysqli_fetch_array($lista)) {
															?>
															<tr>
																<td>
																...
																<td>
																	<center>
																		<div class="d7">
																			<?php 
																			echo $mostrar['nombre_alumno'].' '.$mostrar['apellido_alumno'] ;
																			?>
																		</div>
																	</center>
																</td>
																<td>
																	<center>
																		<div class="d7">
																			<?php echo $mostrar['nombre_carrera'] ?>
																		</div>
																	</center>
																</td>
																<td>
																	<center>
																		<div class="d7">
																			<input type="button" id="escoj" class="btn_2" value="ESCOJER">
																		</div>
																	</center>
																</td>
															</tr>
