	...
	<?php
		...
		if (isset($_POST['bbb'])) {
			...
			for ($i=0; $i < $tot ; $i++) { 
				...
				$estt = $_POST[$name];
				$sql = "INSERT INTO `asistencia`(`id_clase2`, `id_dtllmatricula2`, `estad`) 
		...
		<form method="post">
			<div class="tabla_div2">
				<table class="t1">
					...
					<?php
					$idd = $_SESSION['idx'];
					$lista = mYsqli_query($con,"select * from vista_clase1 
						where ESTADO ='ACTIVO' and id_docente ='$idd'") or die("error: ".mysqli_error());
